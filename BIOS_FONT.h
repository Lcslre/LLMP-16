// BIOS 8×8 bitmap font – https://github.com/viler-int10h/vga-text-mode-fonts/releases/tag/2020-11-25
// Each glyph is 8 bytes (rows), bit 7 = leftmost pixel

#ifndef BIOS8X8_FONT_H
#define BIOS8X8_FONT_H
